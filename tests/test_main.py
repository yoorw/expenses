...
from src.main import is_field_valid, is_quit, main, create_expense, calculate_payment_split
...
def test_calculate_payment_split():
    ...
    test_expenses = [
        # {"name": "wells fargo", "amount": Decimal("1498.59"), "due_date": "", "is_split": "yes", "is_active": "yes", "fixed_due_date": "no"},
        # {"name": "kids 529", "amount": Decimal("150"), "due_date": "", "is_split": "yes", "is_active": "yes", "fixed_due_date": "no"},
